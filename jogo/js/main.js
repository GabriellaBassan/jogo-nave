function start() {
  ...
  //criando divs dentro de outras divs
  ...
  var jogo = {}
  var velocidade = 5
  var posicaoY = parseInt(Math.random() * 334) //cria uma posição randomica para o inimigo
  var podeAtirar = true
  var fimdejogo = false
  var pontos = 0
  var salvos = 0
  ...
  function movefundo() {
    ...
    $('#fundoGame').css('background-position', esquerda - 1) //o fundo vai se movimentar 1px a cada 30ms
  }
  ...
  function energia() {
    ...
    if (energiaAtual == 0) {
      ...
      gameOver() //chama a função game over
    }
  }
